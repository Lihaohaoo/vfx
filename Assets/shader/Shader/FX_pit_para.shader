...
Shader "FX/FX_pit_para"
{
	Properties
	{
		...
		_Dissolve("Dissolve", Range( -0.2 , 1)) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( i.vertexColor * ( ( ( tex2DNode40.r * tex2DNode40.a ) * lerpResult14 ) + ( tex2DNode1.r * _Base_color ) ) ).rgb;
			float2 uv_Dissovle_tex = i.uv_texcoord * _Dissovle_tex_ST.xy + _Dissovle_tex_ST.zw;
			float temp_output_1_0_g1 = tex2D( _Dissovle_tex, uv_Dissovle_tex ).r;
			float lerpResult9_g1 = lerp( temp_output_1_0_g1 , ( 1.0 - temp_output_1_0_g1 ) , 0.0);
			float lerpResult35 = lerp( _Dissolve , i.uv2_tex4coord2.z , _Custm_dissolve);
			float temp_output_3_0_g1 = _Dissolve_Soft;
			o.Alpha = ( tex2DNode1.r * saturate( ( ( ( ( lerpResult9_g1 + 1.0 ) - ( lerpResult35 * ( 1.0 + ( 1.0 - temp_output_3_0_g1 ) ) ) ) - temp_output_3_0_g1 ) / ( 1.0 - temp_output_3_0_g1 ) ) ) * _opacity );
		}
...
/*ASEBEGIN
Version=18900
464;662;1447;669;1859.686;380.9425;1.3;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;12;-2209.563,-103.9026;Inherit;True;Property;_Parallax_tex;Parallax_tex;4;0;Create;True;0;0;0;False;0;False;None;7ea460cae1a2c9a41b65b47e69816041;False;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;8;-2176.134,97.72916;Inherit;False;Property;_Parallax_scale;Parallax_scale;3;0;Create;True;0;0;0;False;0;False;0;-0.022;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ParallaxOcclusionMappingNode;13;-1802.121,-91.85799;Inherit;False;0;128;False;-1;128;False;-1;2;0.02;0;False;1,1;False;0,0;8;0;FLOAT2;0,0;False;1;SAMPLER2D;;False;7;SAMPLERSTATE;;False;2;FLOAT;0.02;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-1223.875,-1286.92;Inherit;False;Property;_Wenli_tex_V;Wenli_tex_V;14;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-1224.875,-1371.92;Inherit;False;Property;_Wenli_tex_U;Wenli_tex_U;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1305.318,-111.8486;Inherit;True;Property;_Base_tex;Base_tex;1;0;Create;True;0;0;0;False;0;False;-1;None;7ea460cae1a2c9a41b65b47e69816041;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;21;-594.6335,-196.0918;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1052.749,-572.2366;Inherit;False;Property;_Emissive_power;Emissive_power;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;16;-788.7123,-792.0965;Inherit;False;Property;_Color1;Color 1;6;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;40;-474.908,-1514.885;Inherit;True;Property;_Wenli_tex;Wenli_tex;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;17;-741.7967,-601.3704;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;15;-791.0203,-966.8401;Inherit;False;Property;_Color0;Color 0;5;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;36;-1513.927,827.3643;Inherit;False;Property;_Custm_dissolve;Custm_dissolve;12;2;[Toggle];[Enum];Create;True;0;2;OFF;0;ON;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-1581.54,524.0079;Inherit;False;Property;_Dissolve;Dissolve;10;0;Create;True;0;0;0;False;0;False;1;0;-0.2;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;47;-155.5702,-1386.504;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;22;-1163.068,120.6952;Inherit;False;Property;_Base_color;Base_color;8;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-1167.007,722.0062;Inherit;False;Property;_Dissolve_Soft;Dissolve_Soft;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-73.65247,-1046.279;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;30;-1560.54,307.0079;Inherit;True;Property;_Dissovle_tex;Dissovle_tex;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-862.3729,633.8644;Inherit;False;Property;_opacity;opacity;2;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;25;0.635587,-341.0154;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;38;-925.491,312.6122;Inherit;False;Dissolve;-1;;1;65b517fa77828494c921c6a01fca4295;0;4;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=A29E6317AC3EC883F0D9A6B2AA0468B4A0BE2E91