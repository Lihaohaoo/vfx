...
Shader "FX/FX_Lbeer"
{
	Properties
	{
		...
		[HideInInspector]_offset_U("_offset_U", Float) = 0
		...
		[HDR]_Main_Color_1("Main_Color_1", Color) = (1,1,1,1)
		[HDR]_Main_Color_0("Main_Color_0", Color) = (0,0,0,0)
		...
		[Enum(Off,0,On,1)]_Main_tex_clamp_U("Main_tex_clamp_U", Float) = 0
		[Enum(Off,0,On,1)]_Main_tex_clamp_V("Main_tex_clamp_V", Float) = 0
		...
		[Enum(Off,0,On,1)]_Opacity_dissolve_part_trail("Opacity_dissolve_part_trail", Float) = 0
		...
		[Enum(Off,0,On,1)]_Clamp("Clamp", Float) = 1
	...
	SubShader
	{
		...
		uniform float4 _Main_Color_0;
		uniform float4 _Main_Color_1;
		...
		uniform float _Main_tex_clamp_U;
		uniform float _Main_tex_clamp_V;
		...
		uniform float4 _Dissolvegradent_ST;
		...
		uniform float _Opacity_dissolve_part_trail;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 lerpResult40_g124 = lerp( v.texcoord.xy , (ase_screenPosNorm).xy , _Vertex_screen_UV);
			float temp_output_19_0_g124 = (lerpResult40_g124).x;
			float temp_output_31_0_g124 = _Vertex_offset_scale;
			float temp_output_26_0_g124 = (lerpResult40_g124).y;
			float2 appendResult20_g124 = (float2(temp_output_19_0_g124 , ( ( temp_output_19_0_g124 * temp_output_31_0_g124 ) + temp_output_26_0_g124 )));
			float2 appendResult28_g124 = (float2(( temp_output_19_0_g124 + ( temp_output_26_0_g124 * temp_output_31_0_g124 ) ) , temp_output_26_0_g124));
			float2 lerpResult29_g124 = lerp( appendResult20_g124 , appendResult28_g124 , _Vertex_UV);
			...
			float2 lerpResult505 = lerp( lerpResult29_g124 , lerpResult58_g90 , _Vertex_tex_radial);
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 ase_screenPosNorm = ase_screenPos / ase_screenPos.w;
			ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
			float2 lerpResult40_g128 = lerp( i.uv_texcoord , (ase_screenPosNorm).xy , _Main_screen_UV);
			float temp_output_19_0_g128 = (lerpResult40_g128).x;
			...
			float temp_output_31_0_g128 = lerpResult534;
			float temp_output_26_0_g128 = (lerpResult40_g128).y;
			float2 appendResult20_g128 = (float2(temp_output_19_0_g128 , ( ( temp_output_19_0_g128 * temp_output_31_0_g128 ) + temp_output_26_0_g128 )));
			float2 appendResult28_g128 = (float2(( temp_output_19_0_g128 + ( temp_output_26_0_g128 * temp_output_31_0_g128 ) ) , temp_output_26_0_g128));
			float2 lerpResult29_g128 = lerp( appendResult20_g128 , appendResult28_g128 , _Main_UV);
			float2 uv_TexCoord30_g108 = i.uv_texcoord * float2( 2,2 );
			float2 temp_output_25_0_g108 = ( uv_TexCoord30_g108 - float2( 1,1 ) );
			float2 appendResult21_g108 = (float2(frac( ( atan2( (temp_output_25_0_g108).x , (temp_output_25_0_g108).y ) / 6.28318548202515 ) ) , length( temp_output_25_0_g108 )));
			float temp_output_44_0_g108 = (saturate( appendResult21_g108 )).x;
			float temp_output_62_0_g108 = lerpResult534;
			float temp_output_45_0_g108 = (appendResult21_g108).y;
			float2 appendResult49_g108 = (float2(temp_output_44_0_g108 , ( ( temp_output_44_0_g108 * temp_output_62_0_g108 ) + temp_output_45_0_g108 )));
			float2 appendResult50_g108 = (float2(( temp_output_44_0_g108 + ( temp_output_45_0_g108 * temp_output_62_0_g108 ) ) , temp_output_45_0_g108));
			float2 lerpResult58_g108 = lerp( appendResult49_g108 , appendResult50_g108 , _Main_UV);
			float2 lerpResult491 = lerp( lerpResult29_g128 , lerpResult58_g108 , _Main_tex_radial);
			...
			float Of_u612 = _offset_U;
			float2 appendResult585 = (float2(( _Main_Tex.z + ( _Main_Tex.x * Of_u612 ) ) , _Main_Tex.w));
			float2 temp_output_61_0 = (appendResult585);
			...
			float temp_output_571_0 = (panner68).x;
			float lerpResult85 = lerp( temp_output_571_0 , saturate( temp_output_571_0 ) , _Main_tex_clamp_U);
			float temp_output_574_0 = (panner68).y;
			float lerpResult575 = lerp( temp_output_574_0 , saturate( temp_output_574_0 ) , _Main_tex_clamp_V);
			float2 appendResult572 = (float2(lerpResult85 , lerpResult575));
			float2 appendResult113 = (float2(_Noise_speed_U , _Noise_speed_V));
			float2 lerpResult40_g126 = lerp( i.uv_texcoord , (ase_screenPosNorm).xy , _Noise_screen_UV);
			float temp_output_19_0_g126 = (lerpResult40_g126).x;
			float temp_output_31_0_g126 = _Noisek_offset_scale;
			float temp_output_26_0_g126 = (lerpResult40_g126).y;
			float2 appendResult20_g126 = (float2(temp_output_19_0_g126 , ( ( temp_output_19_0_g126 * temp_output_31_0_g126 ) + temp_output_26_0_g126 )));
			float2 appendResult28_g126 = (float2(( temp_output_19_0_g126 + ( temp_output_26_0_g126 * temp_output_31_0_g126 ) ) , temp_output_26_0_g126));
			float2 lerpResult29_g126 = lerp( appendResult20_g126 , appendResult28_g126 , _Noise_UV);
			...
			float2 lerpResult527 = lerp( lerpResult29_g126 , lerpResult58_g96 , _Noise_tex_radial);
			...
			float4 tex2DNode1 = tex2D( _Main_tex, ( appendResult572 + Noise43 ) );
			...
			float4 lerpResult564 = lerp( _Main_Color_0 , _Main_Color_1 , lerpResult452);
			...
			float2 lerpResult40_g127 = lerp( i.uv_texcoord , (ase_screenPosNorm).xy , _Dissolve_screen_UV);
			float temp_output_19_0_g127 = (lerpResult40_g127).x;
			float lerpResult538 = lerp( _Dissolve_offset_scale , ( _Dissolve_offset_scale + Custom2_w316 ) , Use_custom327);
			float temp_output_31_0_g127 = lerpResult538;
			float temp_output_26_0_g127 = (lerpResult40_g127).y;
			float2 appendResult20_g127 = (float2(temp_output_19_0_g127 , ( ( temp_output_19_0_g127 * temp_output_31_0_g127 ) + temp_output_26_0_g127 )));
			float2 appendResult28_g127 = (float2(( temp_output_19_0_g127 + ( temp_output_26_0_g127 * temp_output_31_0_g127 ) ) , temp_output_26_0_g127));
			float2 lerpResult29_g127 = lerp( appendResult20_g127 , appendResult28_g127 , _Dissove_UV);
			...
			float2 lerpResult533 = lerp( lerpResult29_g127 , lerpResult58_g98 , _Dissolve_tex_radial);
			...
			float2 appendResult614 = (float2(( ( _Dissolve_Tex.x * Of_u612 ) + _Dissolve_Tex.z ) , _Dissolve_Tex.w));
			float2 temp_output_150_0 = (appendResult614);
			...
			float2 uv_Dissolvegradent = i.uv_texcoord * _Dissolvegradent_ST.xy + _Dissolvegradent_ST.zw;
			float cos363 = cos( ( ( _Dissolve_gradent_Rotator * UNITY_PI ) / 180.0 ) );
			float sin363 = sin( ( ( _Dissolve_gradent_Rotator * UNITY_PI ) / 180.0 ) );
			float2 rotator363 = mul( uv_Dissolvegradent - float2( 0.5,0.5 ) , float2x2( cos363 , -sin363 , sin363 , cos363 )) + float2( 0.5,0.5 );
			float2 temp_output_364_0 = saturate( rotator363 );
			float lerpResult228 = lerp( tex2DNode163.r , ( tex2DNode163.r - ( 1.0 - ( tex2D( _Dissolvegradent, ( ( temp_output_364_0 * (_Dissolve_gradent_Tex).xy ) + (_Dissolve_gradent_Tex).zw ) ).r / saturate( ( 1.0 - _FixedPower1 ) ) ) ) ) , _Use_dissolve_gradent);
			float temp_output_1_0_g101 = lerpResult228;
			float lerpResult9_g101 = lerp( temp_output_1_0_g101 , ( 1.0 - temp_output_1_0_g101 ) , 0.0);
			float lerpResult626 = lerp( _Dissolve , ( 1.0 - i.vertexColor.a ) , _Opacity_dissolve_part_trail);
			float Custom1_z312 = i.uv2_texcoord2.z;
			float lerpResult331 = lerp( lerpResult626 , ( _Dissolve + Custom1_z312 ) , Use_custom327);
			float temp_output_3_0_g101 = _Dissolve_soft;
			float temp_output_183_0 = saturate( ( ( ( ( lerpResult9_g101 + 1.0 ) - ( lerpResult331 * ( 1.0 + ( 1.0 - temp_output_3_0_g101 ) ) ) ) - temp_output_3_0_g101 ) / ( 1.0 - temp_output_3_0_g101 ) ) );
			float temp_output_555_0 = frac( ( 1.0 - temp_output_183_0 ) );
			float temp_output_562_0 = saturate( temp_output_555_0 );
			float4 Dissove_edge_color192 = ( _Dissolve_color * temp_output_562_0 );
			float Dissolve_edge432 = temp_output_562_0;
			float4 temp_cast_5 = (( Dissolve_edge432 * _Edge_black_scale )).xxxx;
			o.Emission = ( ( ( lerpResult564 * float4( Color177 , 0.0 ) * float4( Gradent251 , 0.0 ) ) + lerpResult300 + Dissove_edge_color192 ) - temp_cast_5 ).rgb;
			float2 appendResult129 = (float2(_Mask_speed_U , _Mask_speed_V));
			float2 lerpResult40_g125 = lerp( i.uv_texcoord , (ase_screenPosNorm).xy , _Mask_screen_UV);
			float temp_output_19_0_g125 = (lerpResult40_g125).x;
			float temp_output_31_0_g125 = _Mask_offset_scale;
			float temp_output_26_0_g125 = (lerpResult40_g125).y;
			float2 appendResult20_g125 = (float2(temp_output_19_0_g125 , ( ( temp_output_19_0_g125 * temp_output_31_0_g125 ) + temp_output_26_0_g125 )));
			float2 appendResult28_g125 = (float2(( temp_output_19_0_g125 + ( temp_output_26_0_g125 * temp_output_31_0_g125 ) ) , temp_output_26_0_g125));
			float2 lerpResult29_g125 = lerp( appendResult20_g125 , appendResult28_g125 , _Mask_UV);
			...
			float2 lerpResult520 = lerp( lerpResult29_g125 , lerpResult58_g93 , _Mask_tex_radial);
...
/*ASEBEGIN
Version=19100
Node;AmplifyShaderEditor.CommentaryNode;633;-1621.543,-622.5426;Inherit;False;468.89;172.2124;Trail_offset;2;612;611;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;627;-362.0549,1503.233;Inherit;False;827.9553;348.2115;Opacity_dissolve;5;623;631;628;626;632;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;549;-2232.466,-602.6592;Inherit;False;601.9861;518.3137;UV_vave_power;5;546;548;543;545;550;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;326;-1576.533,-159.3598;Inherit;False;Property;_Custom;Custom;4;1;[Enum];Create;True;0;2;Off;0;On;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;359;-2842.984,2661.094;Inherit;False;Property;_Dissolve_gradent_Rotator;Dissolve_gradent_Rotator;71;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;140;-1246.157,1581.499;Inherit;False;Property;_Noise_scale;Noise_scale;41;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;87;-2541.726,-12.58177;Inherit;False;2353.65;647.4432;Main_tex;35;1;67;256;258;12;44;85;86;84;68;15;14;13;324;376;491;325;328;61;59;257;521;70;18;567;571;572;573;574;575;584;585;586;613;618;01;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;205;-1773.76,2709.043;Inherit;False;Property;_FixedPower1;Dissolve_gradent_width;70;0;Create;False;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;137;-2508.922,995.2968;Inherit;False;Property;_Mask_Tex;Mask_Tex;29;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;160;-1198.256,2222.287;Inherit;False;Property;_Dissove_tex_clamp;Dissove_tex_clamp;54;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;275;-2796.501,3212.698;Inherit;False;Property;_Gradent_Rotator;Gradent_Rotator;76;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;161;-1126.256,2056.287;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;378;-2863.92,4352.13;Inherit;False;Property;_Vertex_Rotator;Vertex_Rotator;83;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1631.558,470.8614;Inherit;False;Property;_Main_speed_U;Main_speed_U;25;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1630.558,550.8615;Inherit;False;Property;_Main_speed_V;Main_speed_V;26;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;135;-2036.004,1110.155;Inherit;False;Property;_Mask_speed_U;Mask_speed_U;36;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;234;-2471.127,3376.487;Inherit;False;Property;_Gradent_Tex;Gradent_Tex;74;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;136;-2035.004,1190.155;Inherit;False;Property;_Mask_speed_V;Mask_speed_V;37;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;283;-2186.188,4014.102;Inherit;False;Property;_Fresnel_one_minus;Fresnel_one_minus;91;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;163;-758.4084,1964.182;Inherit;True;Property;_Dissolove_tex;Dissolove_tex;50;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;285;-1767.188,4000.102;Inherit;False;Property;_Fresnelpower;Fresnel+power;94;0;Create;True;0;0;0;False;0;False;1;0.95;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;380;-2545.208,4447.283;Inherit;False;Property;_Vertex_Tex;Vertex_Tex;81;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;230;-469.8929,2200.034;Inherit;False;Property;_Use_dissolve_gradent;Use_dissolve_gradent;67;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;353;-474.7273,-779.6596;Inherit;False;Property;_Depth_fade;Depth_fade;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;145;-1191.37,970.5154;Inherit;False;Property;_Mask_tex_clamp;Mask_tex_clamp;31;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;143;-1119.37,804.5153;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode;231;423.224,1829.115;Inherit;False;2007.468;735.536;Dissolve_color;17;188;432;183;164;194;196;192;560;555;561;556;557;562;189;187;331;191;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;191;430.0425,2372.442;Inherit;False;Property;_Dissolve_soft;Dissolve_soft;63;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;233;-2039.644,3542.403;Inherit;False;Property;_Gradent_speed_V;Gradent_speed_V;78;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;243;-1759.326,3319.094;Inherit;False;Property;_Gradent_tex_radial;Gradent_tex_radial;75;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;240;-2040.644,3462.403;Inherit;False;Property;_Gradent_speed_U;Gradent_speed_U;77;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;187;427.8245,2297.624;Inherit;False;Property;_Dissolve_edge;Dissolve_edge;64;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;390;-2089.725,4613.199;Inherit;False;Property;_Vertex_speed_U;Vertex_speed_U;89;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;391;-2093.725,4693.199;Inherit;False;Property;_Vertex_speed_V;Vertex_speed_V;90;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;133;-803.522,713.7106;Inherit;True;Property;_Mask_tex;Mask_tex;27;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;175;-324.3806,-1020.317;Inherit;False;Property;_Main_color;Main_color;9;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;395;-1317.765,4460.36;Inherit;False;Property;_Vertex_scale;Vertex_scale;88;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;287;-1398.44,4015.543;Inherit;False;Property;_Fresnel_color;Fresnel_color;95;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0.322298,1.515717,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;304;-461.3964,736.2181;Inherit;False;Property;_Mask_Split;Mask_Split;28;0;Create;True;0;0;0;True;0;False;0;0;0;True;;KeywordEnum;4;R;G;B;A;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;254;-1002.388,3279.149;Inherit;False;Property;_Desatruate;Desatruate;79;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;412;-1222.854,4724.935;Inherit;True;Property;_vertex_mask;vertex_mask;82;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;398;-1171.301,4218.196;Inherit;True;Property;_Vertex_tex;Vertex_tex;80;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;345;-40.0105,918.7766;Inherit;False;Property;_Opacity_power;Opacity_power;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;290;-1072.895,4000.75;Inherit;False;Property;_Use_fresnel_color;Use_fresnel_color;92;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;346;-29.8105,991.3767;Inherit;False;Property;_Opacity_scale;Opacity_scale;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;340.0814,-922.9353;Inherit;False;Property;_AddBlend;Add/Blend;3;1;[Enum];Create;True;0;2;Add;1;Blend;10;0;True;0;False;10;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;165;-2553.06,1915.482;Inherit;False;2415.935;1085.727;Comment;25;151;153;148;373;370;372;377;150;155;154;158;268;269;270;533;368;616;615;620;362;186;364;621;622;410;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;436;744.5766,345.6292;Inherit;False;Property;_Edge_black_scale;Edge_black_scale;65;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;356;-280.5283,-650.5039;Inherit;False;Property;_Use_Depth_fade;Use_Depth_fade;7;1;[Enum];Create;True;0;2;Off;0;On;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;121;-1119.693,1347.335;Inherit;True;Property;_Noise_tex;Noise_tex;38;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;447;-1445.512,3451.197;Inherit;False;Property;_Noise_gradent;Noise_gradent;43;1;[Enum];Create;True;0;2;off;0;on;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;169;-176.9534,96.09109;Inherit;False;Property;_Main_Split;Main_Split;16;0;Create;True;0;0;0;True;0;False;1;0;3;True;;KeywordEnum;4;R;G;B;A;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;172;-198.094,253.8926;Inherit;False;Property;_Use_base_color;Use_base_color;17;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;449;21.6173,144.804;Inherit;False;Property;_Main_control;Main_control;12;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;296;-1087.474,4087.152;Inherit;False;Property;_Use_fresnel_opacity;Use_fresnel_opacity;93;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;461;749.522,-924.0104;Inherit;False;Property;_Z_write_mode;Z_write_mode;96;1;[Enum];Create;True;0;3;Defult;0;On;1;Off;2;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;389;-3357.48,4410.018;Inherit;False;Property;_Vertex_tex_radial;Vertex_tex_radial;84;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;509;-3788.183,4333.917;Inherit;False;Property;_Vertex_screen_UV;Vertex_screen_UV;87;1;[Enum];Create;True;0;2;OFF;0;ON;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;511;-3788.946,4153.235;Inherit;False;Property;_Vertex_UV;Vertex_UV;85;1;[Enum];Create;True;0;2;U;0;V;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;510;-3820.946,4246.235;Inherit;False;Property;_Vertex_offset_scale;Vertex_offset_scale;86;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-2533.386,826.4457;Inherit;False;Property;_Mask_tex_radial;Mask_tex_radial;32;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;262;-2710.2,898.2001;Inherit;False;Property;_Mask_Rotator;Mask_Rotator;30;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-2348.541,151.1534;Inherit;False;Property;_Main_tex_radial;Main_tex_radial;20;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;259;-2714.655,214.2833;Inherit;False;Property;_Main_Rotator;Main_Rotator;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;515;-3085.944,652.2056;Inherit;False;Property;_Mask_UV;Mask_UV;33;1;[Enum];Create;True;0;2;U;0;V;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;516;-3139.944,727.2056;Inherit;False;Property;_Mask_offset_scale;Mask_offset_scale;34;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;517;-3124.181,811.8873;Inherit;False;Property;_Mask_screen_UV;Mask_screen_UV;35;1;[Enum];Create;True;0;2;OFF;0;ON;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-1778.117,1664.338;Inherit;False;Property;_Noise_speed_U;Noise_speed_U;48;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;109;-1777.117,1744.338;Inherit;False;Property;_Noise_speed_V;Noise_speed_V;49;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;266;-2737.861,1585.178;Inherit;False;Property;_Noise_Rotator;Noise_Rotator;40;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;103;-2492.071,1679.274;Inherit;False;Property;_Noise_Tex;Noise_Tex;39;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;110;-2496.269,1490.247;Inherit;False;Property;_Noise_tex_radial;Noise_tex_radial;44;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;524;-3068.479,1295.021;Inherit;False;Property;_Noise_UV;Noise_UV;45;1;[Enum];Create;True;0;2;U;0;V;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;525;-3122.479,1370.021;Inherit;False;Property;_Noisek_offset_scale;Noisek_offset_scale;46;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;526;-3106.716,1454.703;Inherit;False;Property;_Noise_screen_UV;Noise_screen_UV;47;1;[Enum];Create;True;0;2;OFF;0;ON;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;155;-1653.891,2296.926;Inherit;False;Property;_Dissolve_speed_U;Dissolve_speed_U;59;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;154;-1652.891,2376.926;Inherit;False;Property;_Dissolve_speed_V;Dissolve_speed_V;60;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;150;-2000.143,2185.927;Inherit;False;False;False;True;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;271;-2725.666,2233.289;Inherit;False;Property;_Dissolve_Rotator;Dissolve_Rotator;52;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;152;-2748.105,2154.385;Inherit;False;Property;_Dissolve_tex_radial;Dissolve_tex_radial;55;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;493;-3108.187,-39.03973;Inherit;False;Property;_Main_UV;Main_UV;21;1;[Enum];Create;True;0;2;U;0;V;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;495;-3449.187,-249.0397;Inherit;False;Property;_Main_offset_scale;Main_offset_scale;22;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;532;-3178.573,2066.974;Inherit;False;Property;_Dissolve_screen_UV;Dissolve_screen_UV;58;1;[Enum];Create;True;0;2;OFF;0;ON;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;530;-3137.336,1858.292;Inherit;False;Property;_Dissove_UV;Dissove_UV;56;1;[Enum];Create;True;0;2;U;0;V;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;531;-3587.336,1753.292;Inherit;False;Property;_Dissolve_offset_scale;Dissolve_offset_scale;57;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-466.4757,45.21822;Inherit;True;Property;_Main_tex;Main_tex;13;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;158763f99b6ff6d499900313836887d3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;551;-2043.415,-111.5499;Inherit;False;Property;_V_power1;V_power1;24;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;183;1280.273,1904.796;Inherit;True;Dissolve;-1;;101;cf9a8bad52fbab443a0a200abdef43f6;0;4;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;188;1287.714,2153.413;Inherit;True;Dissolve;-1;;102;cf9a8bad52fbab443a0a200abdef43f6;0;4;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;164;1545.163,1818.447;Inherit;False;Dissovle;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;196;2187.167,2032.481;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;432;2185.013,2132.257;Inherit;False;Dissolve_edge;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;194;1936.723,1876.596;Inherit;False;Property;_Dissolve_color;Dissolve_color;66;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;560;1541.526,1958.117;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;192;2331.728,2027.218;Inherit;False;Dissove_edge_color;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;561;1528.17,2153.828;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;556;1661.811,2153.63;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;557;1770.751,2129.876;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;555;1677.721,1957.758;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;562;1977.135,2053.744;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;563;-1734.654,-133.7249;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;564;774.5646,-216.0679;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;566;252.5646,-416.0679;Inherit;False;Property;_Main_Color_1;Main_Color_1;10;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;565;257.5646,-588.0679;Inherit;False;Property;_Main_Color_0;Main_Color_0;11;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;68;-1310,69.93449;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;18;-576.8237,85.4156;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0.5;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;571;-1135.571,-25.12387;Inherit;False;True;False;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;84;-945.899,35.36551;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-1006.899,103.3656;Inherit;False;Property;_Main_tex_clamp_U;Main_tex_clamp_U;18;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;44;-734.6801,478.226;Inherit;False;43;Noise;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;572;-694.5713,93.87613;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;85;-790.8028,-16.63448;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;575;-847.5713,188.8761;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;573;-1075.571,332.8761;Inherit;False;Property;_Main_tex_clamp_V;Main_tex_clamp_V;19;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;574;-1149.571,176.8761;Inherit;False;False;True;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;567;-989.5713,257.8761;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;496;-2822.686,115.1602;Inherit;False;Radio_UVring;-1;;108;448eee16a1283c34eba4b217ca5bee2c;0;3;61;FLOAT;0;False;62;FLOAT;0;False;40;FLOAT4;0,0,0,0;False;1;FLOAT2;41
Node;AmplifyShaderEditor.SimpleAddOpNode;376;-1886.26,383.8252;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;328;-1933.239,483.0045;Inherit;False;327;Use_custom;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;324;-1698.078,348.1867;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;325;-2177.87,505.0063;Inherit;False;311;Custom1_xy;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;61;-2039.758,296.7888;Inherit;False;False;False;True;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;416;-3125.424,141.6419;Inherit;False;Property;_Main_screen_UV;Main_screen_UV;23;1;[Enum];Create;True;0;2;OFF;0;ON;1;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;602;-3465.876,4159.506;Inherit;False;UV_chamfer_offset;-1;;124;d3e76986f1dd0804c84cb7f1a0379131;0;4;42;FLOAT2;0,0;False;35;FLOAT;0;False;31;FLOAT;0;False;41;FLOAT;0;False;1;FLOAT2;30
Node;AmplifyShaderEditor.FunctionNode;603;-2828.373,654.4876;Inherit;False;UV_chamfer_offset;-1;;125;d3e76986f1dd0804c84cb7f1a0379131;0;4;42;FLOAT2;0,0;False;35;FLOAT;0;False;31;FLOAT;0;False;41;FLOAT;0;False;1;FLOAT2;30
Node;AmplifyShaderEditor.FunctionNode;604;-2831.299,1309.014;Inherit;False;UV_chamfer_offset;-1;;126;d3e76986f1dd0804c84cb7f1a0379131;0;4;42;FLOAT2;0,0;False;35;FLOAT;0;False;31;FLOAT;0;False;41;FLOAT;0;False;1;FLOAT2;30
Node;AmplifyShaderEditor.FunctionNode;605;-2831.156,1918.285;Inherit;False;UV_chamfer_offset;-1;;127;d3e76986f1dd0804c84cb7f1a0379131;0;4;42;FLOAT2;0,0;False;35;FLOAT;0;False;31;FLOAT;0;False;41;FLOAT;0;False;1;FLOAT2;30
Node;AmplifyShaderEditor.FunctionNode;606;-2821.016,-25.65751;Inherit;False;UV_chamfer_offset;-1;;128;d3e76986f1dd0804c84cb7f1a0379131;0;4;42;FLOAT2;0,0;False;35;FLOAT;0;False;31;FLOAT;0;False;41;FLOAT;0;False;1;FLOAT2;30
Node;AmplifyShaderEditor.TextureCoordinatesNode;576;-3168.274,-340.2809;Inherit;False;0;1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;368;-2512.987,2812.814;Inherit;False;Property;_Dissolve_gradent_Tex;Dissolve_gradent_Tex;69;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;585;-2173.411,303.3676;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;614;-2167.482,2317.354;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;586;-2202.978,492.873;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;619;-2579.152,295.606;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;613;-2589.355,389.0842;Inherit;False;612;Of_u;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;45;-2827.498,334.9232;Inherit;False;Property;_Main_Tex;Main_Tex;14;0;Create;True;0;0;0;False;0;False;1,1,0,0;5,5,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;618;-2436.152,314.606;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;146;-2745.052,2315.661;Inherit;False;Property;_Dissolve_Tex;Dissolve_Tex;51;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;620;-2440.258,2321.361;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;615;-2304.473,2315.75;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;584;-2326.271,407.9026;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;616;-2650.525,2503.323;Inherit;False;612;Of_u;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;186;-1490.172,2512.185;Inherit;True;Property;_Dissolvegradent;Dissolve-gradent;68;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;364;-2100.381,2550.669;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;621;-1957.899,2515.204;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;362;-2528.378,2535.688;Inherit;False;0;186;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;410;-1278.331,2413.776;Inherit;False;Property;_Nosie_dissolve;Nosie_dissolve;42;1;[Enum];Create;True;0;2;OFF;0;ON;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;622;-2275.899,2662.204;Inherit;False;Property;_Clamp;Clamp;72;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;624;221.8054,2450.234;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;626;153.9004,1640.444;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;184;-124.1418,1926.686;Inherit;False;Property;_Dissolve;Dissolve;62;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;628;-259.8059,1724.619;Inherit;False;Property;_Opacity_dissolve_part_trail;Opacity_dissolve_part_trail;53;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;631;-56.56641,1578.613;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;623;-357.0549,1548.233;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;632;-188.5664,1577.613;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;612;-1376.653,-566.3302;Inherit;False;Of_u;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;611;-1571.543,-572.5426;Inherit;False;Property;_offset_U;_offset_U;2;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;196;1;562;0
WireConnection;432;0;562;0
WireConnection;560;0;183;0
WireConnection;192;0;196;0
WireConnection;561;0;188;0
WireConnection;556;0;561;0
WireConnection;557;0;555;0
WireConnection;557;1;556;0
WireConnection;555;0;560;0
WireConnection;562;0;555;0
WireConnection;563;0;545;0
WireConnection;564;0;565;0
WireConnection;564;1;566;0
WireConnection;564;2;452;0
WireConnection;68;0;12;0
WireConnection;68;2;15;0
WireConnection;18;0;572;0
WireConnection;18;1;44;0
WireConnection;571;0;68;0
WireConnection;84;0;571;0
WireConnection;572;0;85;0
WireConnection;572;1;575;0
WireConnection;85;0;571;0
WireConnection;85;1;84;0
WireConnection;85;2;86;0
WireConnection;575;0;574;0
WireConnection;575;1;567;0
WireConnection;575;2;573;0
WireConnection;574;0;68;0
WireConnection;567;0;574;0
WireConnection;59;0;619;0
WireConnection;491;0;606;30
...
WireConnection;61;0;585;0
WireConnection;534;0;495;0
WireConnection;534;1;537;0
WireConnection;534;2;535;0
WireConnection;602;35;511;0
WireConnection;602;31;510;0
WireConnection;602;41;509;0
WireConnection;603;35;515;0
WireConnection;603;31;516;0
WireConnection;603;41;517;0
WireConnection;604;35;524;0
WireConnection;604;31;525;0
WireConnection;604;41;526;0
WireConnection;605;35;530;0
WireConnection;605;31;538;0
WireConnection;605;41;532;0
WireConnection;606;35;493;0
WireConnection;606;31;534;0
WireConnection;606;41;416;0
WireConnection;585;0;584;0
WireConnection;585;1;586;0
WireConnection;614;0;615;0
WireConnection;614;1;146;4
WireConnection;586;0;45;4
WireConnection;619;0;45;0
WireConnection;618;0;45;1
WireConnection;618;1;613;0
WireConnection;620;0;146;1
WireConnection;620;1;616;0
WireConnection;615;0;620;0
WireConnection;615;1;146;3
WireConnection;584;0;45;3
WireConnection;584;1;618;0
WireConnection;186;1;369;0
WireConnection;364;0;363;0
WireConnection;621;0;363;0
WireConnection;621;1;364;0
WireConnection;621;2;622;0
WireConnection;626;0;184;0
WireConnection;626;1;631;0
WireConnection;626;2;628;0
WireConnection;631;0;623;4
WireConnection;632;0;623;4
WireConnection;612;0;611;0
ASEEND*/
//CHKSM=9C841A71BCFECDC8DBECD4D2B7C78616A5FAE24B